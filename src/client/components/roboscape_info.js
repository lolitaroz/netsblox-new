...
import { Bot, Wifi, Chrome, BookOpen, PenTool as Tool, ExternalLink } from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm mb-8 p-6 rounded-lg">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl font-bold text-blue-600 dark:text-white">Required Tools</h2>
              </div>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm p-6 rounded-lg">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-xl font-bold text-blue-600 dark:text-white">RoboScape Publications</h2>
              </div>

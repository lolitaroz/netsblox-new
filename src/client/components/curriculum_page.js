...
import { Cpu, Rocket, GraduationCap, Bird, Sparkles, Users, BookOpen, Lightbulb } from 'lucide-react';
    ...
    <div className="group bg-white dark:bg-slate-800 transition-all duration-300 hover:shadow-xl flex flex-col rounded-2xl">
        <div className="p-6 flex flex-col flex-grow">
            <div className="flex items-start gap-4 mb-4">
                ...
                <h2 className="text-2xl font-bold text-blue-600 dark:text-white">{program.title}</h2>
            </div>
            <p className="text-slate-600 dark:text-slate-300 mb-4 flex-grow">{program.description}</p>
            <button className={`text-white bg-gradient-to-r ${program.color} hover:scale-105 transition-transform duration-300 w-full rounded-2xl`}>
                {program.buttonText}
            </button>
        </div>
    </div>
...
const CurriculumPage = () => {
    ...
    const curriculumPrograms = [
        ...
        },
        {
            ...
            icon: Rocket,
            description: "With RoboScape and RoboScape Online, students can write NetsBlox programs that remotely control physical or virtual robots. Learn about encryption, cipher-breaking, and hack other robots in exciting challenges!",
        ...
        },
        {
            title: "CS Frontiers",
            icon: GraduationCap,
            description: "A Tennessee-approved, year-long high school curriculum covering advanced topics like distributed computing, IoT and Cybersecurity, AI and Machine Learning, and software engineering.",
        ...
        },
        {
            ...
            icon: Bird,
            description: "Create exciting projects using real-world wildlife databases! Learn how technology can help solve conservation problems through hands-on, project-based learning.",
            color: "from-purple-400 to-pink-500",
            href: "#",
        ...
        },
        {
            ...
            icon: Sparkles,
            description: "Dive into the fascinating world of AI! Create your own AI agents, solve puzzles, and learn about everything from classical AI algorithms to the latest advances in modern AI.",
            color: "from-blue-400 to-cyan-500",
            href: "#",

    ...
    const introCards = [
        {
            ...
            content: "BeatBlox integrates music with computing to make learning more appealing, aiming to engage students who may feel excluded from computer science.",
            icon: Users
        },
        {
            title: "Music Creation and Customization",
            content: "It allows students to compose music using simulated digital instruments, add special effects, and incorporate public domain tunes, making it versatile and accessible for creative expression.",
            icon: PenTool
        },
        {
            title: "Collaboration and Integration with Other Media",
            content: "BeatBlox's networking feature enables students to collaborate in a digital orchestra and combine music with visualizations or sound effects for games and animations.",
            icon: Layers
        }
    ];
    ...
    const demoSections = [
        {
            ...
            icon: Music,
            videoId: "video-id-1",
            description: "Introduction to BeatBlox showcasing a simple block-based musical effect.",
            projectUrl: "#"
        },
        {
            ...
            icon: Headphones,
            videoId: "video-id-2",
            description: "Beethoven's \"Ode to Joy\" with multiple instruments and score visualization.",
            projectUrl: "#"
        },
        {
        ...
        },
        {
            ...
            icon: Share2,
            videoId: "video-id-4",
            description: "A four-piece band first on a single computer and then by four individual BeatBlox users being played back synchronously.",
            projectUrl: "#"
        },
        {
            ...
            icon: Layers,
            videoId: "video-id-5",
            description: "Helicopter flyby on a single computer first, then in three separate browser tabs, and finally, using distributed audiovisual animation across three computers showing a helicopter moving both visually and acoustically between individually running programs.",
            projectUrl: "#"
        },
        {
            ...
            icon: PenTool,
            videoId: "video-id-6",
            description: "Musical compositions demonstrating ease of access to external devices, such as MIDI keyboards and mobile phones. To try maracas on your phone, you need to install the PhoneIoT mobile app from the app store and then scan the QR code as shown in the video.",
            projectUrl: "#"
        },
        {
            ...
            icon: Headphones,
            videoId: "video-id-7",
            description: "End-to-end demonstration of importing a public domain MIDI song into BeatBlox, changing its key and tempo, and exporting the resulting audio to a file.",
            projectUrl: "#"
        },
        {
            ...
            icon: Music,
            videoId: "video-id-8",
            description: "Two hardware-free instrument implementations allowing users to experiment with playing music without requiring physical hardware or instruments using a webcam only.",
            projectUrl: "#"
        },
        {
            ...
            icon: Users,
            videoId: "video-id-9",
            description: "Sample curricular module with a simple built-in task with integrated assessment and the ability for teachers to examine the process not just the end result.",
            projectUrl: "#"
        }
    ];

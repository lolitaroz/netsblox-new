...
const taglines = [
    { text: "Beats and Music", image: "/images/beats.jpeg?height=600&width=1200", link: "/beatblox", buttonText: "BeatBlox Extension" },
    { text: "Robot Worlds", image: "/images/robot_world.jpeg?height=600&width=1200", link: "/roboscape", buttonText: "RoboScape Extension"},
    { text: "Phone Apps", image: "/images/apps.jpeg?height=600&width=1200", link: "/phoneiot", buttonText: "PhoneIoT Page" },
...
export default function LandingPage() {
    ...
    const features = [
        { icon: Code, title: 'Visual Programming', description: 'Create projects with intuitive block-based coding.' },
        { icon: Cloud, title: 'Cloud-Based', description: 'Access your work from anywhere, anytime.' },
        { icon: Users, title: 'Collaborative', description: 'Work together on projects in real-time.' },
        { icon: Zap, title: 'Powerful', description: 'Build complex simulations and interactive applications.' },
    ]
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-300">
            <main className="container mx-auto px-4 py-16">
                <div className="h-screen">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            style={{ backgroundImage: `url(${taglines[currentTagline].image})` }}
                        />
                    </AnimatePresence>
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                        <div className="text-center">
                            <h1 className="text-4xl sm:text-6xl font-bold text-white mb-4">Dream. Code. Create.</h1>
                            <AnimatePresence mode="wait">
                                <motion.h2
                                    key={currentTagline}
                            ...
                            >
                                {taglines[currentTagline].buttonText}<ChevronRight className="ml-2" size={20} />
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className="text-center mb-20">
                    ...
                    >
                        NetsBlox is more than just a coding platform - it's an educational ecosystem designed to inspire
                        and empower young minds. With our innovative tools and connected approach, students can create
                        distributed programs, collaborate in real-time, and bring their ideas to life through code.
                    </motion.p>
                    <motion.button
                        ...
                        >
                            <feature.icon
                                className={`w-12 h-12 mb-4 ${
                                    hoveredFeature === index ? 'text-blue-500 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'

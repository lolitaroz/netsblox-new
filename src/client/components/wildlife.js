...
import { Bird, Camera, Map, Trees, PresentationIcon, ExternalLink, Gamepad } from "lucide-react";
  ...
  const projects = [
    {
      ...
      description: "This project has students create a program that accesses the \"Wildcam\" NetsBlox service in order to view random images from camera traps placed out in the wild.",
      icon: Camera,
      completedUrl: "#"
    },
    {
      title: "Movebank Animal Tracker",
      description: "This project uses the \"Movebank\" NetsBlox service to access real-world location data from animal-borne tracking collars/tags. Students take this raw location data and combine it with features from the \"GoogleMaps\" NetsBlox service in order to plot the animals' paths on a map.",
      icon: Map,
      completedUrl: "#"
    },
    {
      title: "Tree of Life",
      description: "This project gets students to write code that searches the GBIF online taxonomical database for animals. Students use this data and write code that visually displays information and images about any animal.",
      icon: Trees,
      completedUrl: "#",
      templateUrl: "#"
    },
    {
      ...
      description: "This project has students use the \"Wildcam\" NetsBlox to look up images of specific species. Students then use this data to create a guessing game where players are presented two images and have to decide whether they are images of the same species or not.",
      icon: Gamepad,
      completedUrl: "#"
    }
  ];
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-blue-600 dark:text-white mb-4">Projects</h2>
            ...
            <Card className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm mt-8">
              <CardContent className="p-6">
                <h2 className="text-xl font-bold mb-4 text-blue-600 dark:text-white">Acknowledgements</h2>
                <p className="text-slate-600 dark:text-slate-300">
                  This curriculum was created as part of a larger project sponsored by the National Science Foundation (Award #2312391)
                </p>
              </CardContent>
            </Card>
          </div>

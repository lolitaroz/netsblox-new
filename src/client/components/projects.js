                ...
                <main className="container mx-auto px-4 py-12">
                    ...
                    <div className="max-w-3xl mx-auto text-center mb-16">
                        <p className="text-lg text-slate-600 dark:text-slate-300">
                            Our projects offer collaborative editing in a cloud-based environment, allowing novice programmers to create
                            networked programs like multiplayer games. NetsBlox enables real-world data integration, such as Google Maps,
                            and offers data sources like the Open Movie Database and Sloan Digital Sky Server. Browse through published
                            projects below.
                        </p>
                            ...
                            {featuredProjects.map((project, index) => (
                                ...
                                >
                                    <div className="p-0">
                                        ...
                                        <div className="p-4">
                                            <h3 className="text-xl font-bold text-blue-600 dark:text-white mb-2">{project.title}</h3>
                                            <p className="text-sm text-slate-600 dark:text-slate-300">{project.description}</p>
                                        </div>
                                        <button
                                            className="absolute bottom-4 left-4 right-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold py-2 rounded-full opacity-0 transform translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0"
                                        >
                                            Let's Play!
                                        </button>
                                    </div>
                            ...
                            {mapProjects.map((project, index) => (
                                ...
                                >
                                    <div className="p-0">
                                        ...
                                        <button
                                            className="absolute bottom-4 left-4 right-4 opacity-0 transform translate-y-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0"
                                        >
                                            View Project
                                        </button>
                                    </div>
